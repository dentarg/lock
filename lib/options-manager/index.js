...
function OptionsManager(widget, options) {
  ...
  // force `defaultADUsernameFromEmail` to true if not provided
  // This variable is used
  this.defaultADUsernameFromEmail = null != options.defaultADUsernameFromEmail ? !!options.defaultADUsernameFromEmail : true;
